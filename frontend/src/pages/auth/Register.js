    ...
    <div style={{
      ...
      <div style={{ width:"100%", maxWidth:400 }}>
        <div style={{ textAlign:"center", marginBottom:32 }}>
          ...
          <p className="text-muted" style={{ marginTop:4 }}>Yangi hisob yaratish</p>
        </div>

        <div className="card">
          <h2 style={{ marginBottom:20, textAlign:"center" }}>Ro'yxatdan o'tish</h2>
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div style={{ position:"relative" }}>
                <input type={show ? "text" : "password"} placeholder="Kamida 6 belgi"
          ...
          <p style={{ textAlign:"center", marginTop:16, fontSize:13, color:"var(--text2)" }}>
            Hisob bor?{" "}
            <Link to="/login" style={{ color:"var(--blue)", textDecoration:"none" }}>Kirish</Link>
          </p>
        </div>
      </div>
    </div>
